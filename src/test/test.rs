...
#[tokio::test]
async fn obtener_identificacion_paciente() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/pacientes/identificacion/{}", BASE_URL, id);
...
#[tokio::test]
async fn obtener_especialidad_medico() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/medicos/especialidad/{}", BASE_URL, id);
...
#[tokio::test]
async fn obtener_identificacion_medico() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/medicos/identificacion/{}", BASE_URL, id);
...
#[tokio::test]
async fn obtener_nombre_medicamento() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/medicamentos/{}", BASE_URL, id);
...
#[tokio::test]
async fn obtener_forma_farmaceutica_medicamento() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/medicamentos/formula/{}", BASE_URL, id);
...
#[tokio::test]
async fn obtener_estado_medicamento() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/medicamentos/estado/{}", BASE_URL, id);
...
#[tokio::test]
async fn obtener_dia_cita() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/cita/dia/{}", BASE_URL, id);
...
#[tokio::test]
async fn obtener_hora_cita() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/cita/hora/{}", BASE_URL, id);
...
#[tokio::test]
async fn obtener_medico_cita() {
    let client = Client::new();
    let id = 1;
    let url = format!("{}/cita/medico/{}", BASE_URL, id);
